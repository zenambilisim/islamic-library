...
export interface UseAdminBooksPaginatedReturn {
  books: Book[];
  loading: boolean;
  error: string | null;
  total: number;
...
/**
 * Sayfa tabanlı kitaplar listesi (admin/books tablosu için).
 * API: GET /api/books?page=&limit= (dil filtresi yok)
 */
export function useAdminBooksPaginated(
  initialPageSize: number = DEFAULT_PAGE_SIZE,
  language?: string,
  category?: string
): UseAdminBooksPaginatedReturn {
