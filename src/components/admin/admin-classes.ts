...
export const adminBtnDanger =
  'inline-flex h-10 items-center justify-center gap-2 rounded-full border border-red-200 bg-red-50 px-4 text-sm font-medium text-red-700 transition-colors hover:bg-red-100 disabled:cursor-not-allowed disabled:opacity-50';
...
export const adminBtnIconDanger =
  'inline-flex h-9 w-9 items-center justify-center rounded-full text-red-600 transition-colors hover:bg-red-50 disabled:opacity-50';
...
export const adminAlertError = 'mb-4 rounded-[var(--radius-md)] border border-red-200 bg-red-50 p-3 text-sm text-red-800';

export const adminAlertSuccess =
  'mb-4 rounded-[var(--radius-md)] border border-green-200 bg-green-50 p-3 text-sm text-green-800';
...
export const adminDashCardIcon =
  'flex h-10 w-10 items-center justify-center rounded-full bg-accent-soft text-accent transition-colors group-hover:bg-accent group-hover:text-white';
